...
import Map_lib "mo:map_8_1_0/Map";
import Set_lib "mo:map_8_1_0/Set";
  ...
  public func upgrade(prev_migration_state : MigrationTypes.State, args : MigrationTypes.Args) : MigrationTypes.State {
    ...
    for (thisItem in SB_lib.vals(prev_state.axons)) {
      ...
      for (thisProposal in SB_lib.vals(thisItem.activeProposals)) {
        SB_lib.add<v2_1_1_types.AxonProposal>(
          activeProposals,
          {
            thisProposal with
            ...
            ballots = Map.fromIter<Principal, v2_1_1_types.Ballot>(
              Iter.map<v2_0_1_types.Ballot, (Principal, v2_1_1_types.Ballot)>(
                SB_lib.vals<v2_0_1_types.Ballot>(thisProposal.ballots),
                func(x) {
                  (
                    x.principal,
                    {
      ...
      SB_lib.add<v2_1_1_types.AxonFull>(
        axons,
        {
    ...
    return #v2_1_1(#data({ var axons = axons; var admins = prev_state.admins; var creator = prev_state.creator }));
  };
